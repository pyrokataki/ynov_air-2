...
from .models import Airport, Flight, Passenger, Booking , Annulation
...
class AnnulationAdmin(admin.ModelAdmin):
    list_display = ('passenger','reason', 'booking','date_annulation')
    search_fields = ('passenger','reason', 'booking','date_annulation')
